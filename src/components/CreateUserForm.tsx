...
export default function CreateUserForm({ setActiveForm }: CreateUserFormProps) {
  ...
  return (
    ...
    <form
      ...
      autoComplete='off'
    >
      <h1 className='text-3xl text-center font-bold'>Registre-se</h1>
      ...
      <div className='flex flex-col gap-8 mt-8'>
        ...
        <div>
          <input
            ...
            className={`block w-full bg-zinc-600 text-white p-2 placeholder:text-gray-400 rounded focus:outline-none focus:outline-offset-2 focus:outline-zinc-400
          ${errors?.name && 'border-2 border-red-800 focus:outline-0'}`}
          />
      ...
      <p className='mt-2'>Já tem uma conta?
        <span
